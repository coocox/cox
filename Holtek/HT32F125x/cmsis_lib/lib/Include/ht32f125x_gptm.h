...
#ifndef __HT32F125X_GPTM_H
#define __HT32F125X_GPTM_H
...
typedef enum
{
  GPTM_TRSEL_UEV1G = 0x0,          /*!< Software trigger by seting UEV1G */
  GPTM_TRSEL_TI0S0 = 0x1,          /*!< Filtered channel 0 input */
  GPTM_TRSEL_TI1S1 = 0x2,          /*!< Filtered channel 1 input */
  GPTM_TRSEL_ETIF  = 0x3,          /*!< Filtered external trigger input */
  GPTM_TRSEL_TI0BED = 0x8,          /*!< Triger input 0 both edge detector */
  GPTM_TRSEL_ITI0  = 0x9           /*!< Internal trigger input 0 */
} GPTM_TRSEL_Enum;
/**
...
typedef enum
{
  GPTM_MMSEL_RESET   = 0x00000000,  /*!< Send trigger signal when S/W setting UEV1G or slave restart */
  GPTM_MMSEL_ENABLE  = 0x00010000,  /*!< The counter enable signal is used as trigger output. */
  GPTM_MMSEL_UPDATE  = 0x00020000,  /*!< The update event 1 is used as trigger output. */
...
#define GPTM_INT_UEV1         0x0100  /*!< Update interrupt */
...
#define GPTM_EVENT_UEV1       0x0100  /*!< Update event */
...
#define GPTM_FLAG_UEV1        0x0100  /*!< Update flag */
 ...
 */
#define IS_GPTM_TRSEL(x) ((x == GPTM_TRSEL_UEV1G) || \
                           (x == GPTM_TRSEL_TI0S0) || \
                           (x == GPTM_TRSEL_TI1S1) || \
                           (x == GPTM_TRSEL_ETIF) || \
                           (x == GPTM_TRSEL_TI0BED) || \
 ...
 */
#define IS_GPTM_ITI(x)  (x == GPTM_TRSEL_ITI0)
/**
