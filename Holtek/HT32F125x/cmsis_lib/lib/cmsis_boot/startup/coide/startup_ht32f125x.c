/**
 ******************************************************************************
 * @file      startup_ht32f125x
 * @author    Coocox
 * @version   V1.1
 * @date      03/21/2011
 * @brief     HT32F125 Devices Startup code.
...
void WEAK  USART_IRQHandler(void);
...
{	
  ...
  0,0,0,0,                   /*!< 26-30: Reserved                             */
  0,0,0,0,0,                 /*!< 31-35: Reserved                             */
  GPTM0_IRQHandler,          /*!< 36: General-Purpose Timer0                  */
  GPTM1_IRQHandler,          /*!< 37: General-Purpose Timer1                  */
  0,0,0,0,0,0,               /*!< 38-44: Reserved                             */
  I2C_IRQHandler,            /*!< 45: I2C                                     */
  0,                         /*!< 46: Reserved                                */
  SPI_IRQHandler,            /*!< 47: SPI                                     */
  0,                         /*!< 48: Reserved                                */
  USART_IRQHandler           /*!< 49: USART                                   */
};
...
#pragma weak USART_IRQHandler = Default_Handler
