...
set /p _publish_cox=Please input the MCU platform that to publish(NUC1xx, STM32F1xx£¬HT32F175x, HT32F125x,KLx,NUC122,Template):
...
if %_publish_cox%==KLx goto publish_config_version
