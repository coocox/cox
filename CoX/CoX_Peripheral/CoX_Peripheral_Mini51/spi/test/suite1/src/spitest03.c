...
unsigned char ulSourceData[] = {'1', '2', '3', '4',
                                '5', '6', '7', '8'};
...
static void SPI0MasterInit(void)
{
    ...
    //
    SPIConfig(SPI0_BASE, 1000, SPI_FORMAT_MODE_5 | SPI_DATA_WIDTH8 | 
                                 SPI_MSB_FIRST | SPI_MODE_MASTER);
    
    SPISSConfig(SPI0_BASE, 0, SPI_SS_ACTIVE_LOW_FALLING);
        
    //
    // HardWare Control Transfer Select SS0
    //
    SPIAutoSSEnable(SPI0_BASE, SPI_SS0);
