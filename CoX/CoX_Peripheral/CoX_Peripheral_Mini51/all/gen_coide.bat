...
set v_gen_root=%v_repo_root_self%\CoX\CoX_Peripheral\CoX_Peripheral_Mini51\all\project
set v_cox_peripheral=%v_repo_root_self%\CoX\CoX_Peripheral\CoX_Peripheral_Mini51
...
echo gen coide project: CoX\CoX_Peripheral\CoX_Peripheral_Mini51\all\project
