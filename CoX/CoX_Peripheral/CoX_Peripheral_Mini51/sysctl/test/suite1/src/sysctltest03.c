...
unsigned long ulSysTickClkSource[] = {SYSCTL_STCLK_S_EXT12M,
                                      SYSCTL_STCLK_S_EXT12M_2,
                                      SYSCTL_STCLK_S_HCLK_2,
                                      SYSCTL_STCLK_S_INT22M_2};

unsigned long ulWDT0ClkSource[] = {SYSCTL_PERIPH_WDG_EXT32K,
                                   SYSCTL_PERIPH_WDG_S_HCLK_2048, 
                                   SYSCTL_PERIPH_WDG_S_INT10K};

unsigned long ulUARTClkSource[] = {SYSCTL_PERIPH_UART_S_EXT12M, 
                                   SYSCTL_PERIPH_UART_S_INT22M};

unsigned long ulTIMER0ClkSource[] = {SYSCTL_PERIPH_TMR0_S_EXT12M,
                                     SYSCTL_PERIPH_TMR0_S_HCLK, 
                                     SYSCTL_PERIPH_TMR0_S_INT22M};

unsigned long ulTIMER1ClkSource[] = {SYSCTL_PERIPH_TMR1_S_EXT12M,
                                     SYSCTL_PERIPH_TMR1_S_HCLK, 
                                     SYSCTL_PERIPH_TMR1_S_INT22M};

unsigned long ulPWM01ClkSource[] = {SYSCTL_PERIPH_PWM01_S_HCLK};

unsigned long ulPWM23ClkSource[] = {SYSCTL_PERIPH_PWM23_S_HCLK};

unsigned long ulHCLKSource[] = {SYSCTL_HLCK_S_EXT, 
                                SYSCTL_HLCK_S_INT10K, 
                                SYSCTL_HLCK_S_INT22M};

unsigned long ulHCLKRegister[] = {0, 3, 7};

unsigned long ulPWM45ClkSource[] = {SYSCTL_PERIPH_PWM45_S_HCLK};

unsigned long ulFRQDIVClkSource[] = {SYSCTL_PERIPH_FRQDIV_S_EXT12M, 
                                     SYSCTL_PERIPH_FRQDIV_S_HCLK, 
                                     SYSCTL_PERIPH_FRQDIV_S_INT22M};

unsigned long ulADC0ClkSource[] = {SYSCTL_PERIPH_ADC_S_EXT12M, 
                                   SYSCTL_PERIPH_ADC_S_HCLK, 
                                   SYSCTL_PERIPH_ADC_S_INT22M};
