...
//
//*****************************************************************************
unsigned long ulPeriprerAddr[] = { xWDT_BASE, xTIMER0_BASE, xTIMER1_BASE, 
                                   xSPI0_BASE,xI2C0_BASE,   xADC0_BASE,  
                                   xACMP0_BASE};


unsigned long ulxPeriphEnableMask[] = {SYSCLK_APBCLK_WDCLK_EN,
                SYSCLK_APBCLK_TMR0_EN, SYSCLK_APBCLK_TMR1_EN,
                SYSCLK_APBCLK_SPI0_EN, SYSCLK_APBCLK_I2C0_EN, 
                SYSCLK_APBCLK_ADC_EN,  SYSCLK_APBCLK_ACMP_EN};
...
static void xsysctl_xSysCtlPeripheralDisable2_test(void)
{
    ...
    ulRegVal = xHWREG(SYSCLK_APBCLK);
    TestAssert((0 == (ulRegVal & 0x00700000)), "xsysctl API error!");
