...
static void xI2C003Execute(void)
{
    ...
    //
    // master transfer with interrupt mode
    //
    bFlag = xI2CMasterTransfer(I2C0_BASE, &I2CMasterTrCfg, I2C_TRANSFER_INTERRUPT);
...
//
// xi2c master send and receive with interrupt mode test case struct.
//
