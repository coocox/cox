...
//*****************************************************************************
void 
ACMPIntCallbackInit(unsigned long ulBase, unsigned long ulCompID,
...
//*****************************************************************************
//
//! \brief Comparator0 GPIO selection.
//!
//! \param ulBase is the base address of the comparator module.
//! \param ulSelcet is the active analog gpio input select.
//!
//! This function disables comparator.
//!
//! \return None.
...
//*****************************************************************************
void
ACMPCMPSel(unsigned long ulBase, unsigned long ulSelect)
{
    xASSERT(ulBase == ACMP_BASE);

    xHWREG(ulBase + ACMP_CMPSEL) = ulSelect;
}
...
//*****************************************************************************
void
xACMPEnable(unsigned long ulBase, unsigned long ulCompID)
{
...
//*****************************************************************************
void
xACMPDisable(unsigned long ulBase, unsigned long ulCompID)
{
...
xACMPIntCallbackInit(unsigned long ulBase, unsigned long ulCompID,
                                 xtEventCallback pfnCallback)
{
	ACMPIntCallbackInit(ulBase, ulCompID, pfnCallback);
}
...
//*****************************************************************************
void
xACMPIntEnable(unsigned long ulBase, unsigned long ulCompID)
{
...
//*****************************************************************************
void
xACMPIntDisable(unsigned long ulBase, unsigned long ulCompID)
{
