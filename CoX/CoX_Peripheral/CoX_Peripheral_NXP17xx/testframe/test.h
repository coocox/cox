...
extern uint32 FILE_Print  (const char * pcMsg, ...);
extern uint32 UART_Print  (const char * pcMsg, ...);
extern void   _TestAssert (const char * pcMsg, ...);
...
#else
#define TestAssert(bCondition, ...)                                           \
do{                                                                           \
    if(!(bCondition))                                                         \
    {                                                                         \
        _TestAssert(__VA_ARGS__);                                             \
        FILE_Print("\r\nFILE\t:%s\r\n",__FILE__);                             \
        FILE_Print("\r\nLINE\t:%d\r\n",__LINE__);                             \
    }                                                                         \
}while(0)                                                                     
                                                                              
#endif //End of Enhance Mode
