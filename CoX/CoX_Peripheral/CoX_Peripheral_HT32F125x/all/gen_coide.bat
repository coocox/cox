...
set v_gen_root=%v_repo_root_self%\CoX\CoX_Peripheral\CoX_Peripheral_HT32F125x\all\project
set v_cox_peripheral=%v_repo_root_self%\CoX\CoX_Peripheral\CoX_Peripheral_HT32F125x
...
echo gen coide project: CoX\CoX_Peripheral\CoX_Peripheral_HT32F125x\all\project
