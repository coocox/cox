...
static void xsysctl_SetHCLK_test(void)
{
    ...
    TestAssert((ulTemp == 84000000), "xsysctl API error!");
    ...
    ulTemp = xSysCtlClockGet();
    TestAssert((ulTemp == 36000000), "xsysctl API error!");

    xSysCtlClockSet(24000000, xSYSCTL_OSC_MAIN | xSYSCTL_XTAL_12MHZ);
    ulTemp = xSysCtlClockGet();
...
#if 0
    xSysCtlClockSet(32768, xSYSCTL_OSC_EXTSL);
    ulTemp = xSysCtlClockGet();
