...
set v_gen_root=%v_repo_root_self%\CoX\CoX_Peripheral\CoX_Peripheral_Template\all\project
set v_cox_peripheral=%v_repo_root_self%\CoX\CoX_Peripheral\CoX_Peripheral_Template
...
echo update \startup\startup_coide.c to \resource\cox_coide_empty_project
copy %v_cox_peripheral%\startup\startup_coide.c %v_cox_peripheral%\resource\cox_coide_empty_project >>nul
echo completed
