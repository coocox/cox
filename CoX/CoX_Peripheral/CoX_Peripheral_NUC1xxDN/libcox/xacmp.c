...
//*****************************************************************************    
void
xACMPEnable(unsigned long ulBase, unsigned long ulComp)
{
    unsigned long ulCRAddr;
...
//*****************************************************************************
void
xACMPDisable(unsigned long ulBase, unsigned long ulComp)
{
    unsigned long ulCRAddr;
...
//*****************************************************************************
void
xACMPIntEnable(unsigned long ulBase, unsigned long ulComp)
{
    unsigned long ulCRAddr;
...
//*****************************************************************************
void
xACMPIntDisable(unsigned long ulBase, unsigned long ulComp)
{
    unsigned long ulCRAddr;
