#ifndef _NUC1XX_I2C_H_
#define _NUC1XX_I2C_H_
...
//*****************************************************************************
//
//! \addtogroup NUC1xx_I2C_Master_Error NUC1xx I2C Master Error
//! \brief Values that show I2C Master Error Type
//! Values that can be passed to I2Cx interrupt handler.
//! @{
//
//*****************************************************************************
...
//*****************************************************************************
//
//! \addtogroup NUC1xx_I2C_Event_Master NUC1xx I2C Master Event
...
//*****************************************************************************
//
//! \addtogroup NUC1xx_I2C_Event_Slave NUC1xx I2C Slave Event
...
//*****************************************************************************
//
//! \addtogroup NUC1xx_I2C_INT_Type NUC1xx I2C Interrupt Type
//! \brief Values that show I2C Interrupt Type
//! Values that can be passed to xI2CIntEnable(),xI2CIntDisable().
//! @{
//
...
#define I2C_MASTER_INT_DATA     0x00000080

#define I2C_SLAVE_INT_DATA      0x00000080
