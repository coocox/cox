...
// pwm base value
//
static unsigned long PWNBase[3] = {xPWMA_BASE, xPWMB_BASE, xPWMC_BASE};

//
// pwm channel value
//
static unsigned long PWMChannel[] = { xPWM_CHANNEL0, xPWM_CHANNEL1};
...
//*****************************************************************************
//
//! \brief Get the Test description of xpwm002 register test.
//!
...
{
    return "xpwm, 002, xpwm register test";
}
...
static void xpwm002TearDown(void)
{
    ...
    xSysCtlPeripheralDisable(SYSCTL_PERIPH_PWMC);
}
...
static void xpwm002Execute(void)
{
    ...
    {   
       ...
       TestAssert(ulTemp == TPM_CONF_CSOT,
                   "xpwm, \" PWMCSOTConfigure \" error!"); 
...
//
const tTestCase sTestxpwm002Register = {
    xpwm002GetTest,
    xpwm002Setup,
    xpwm002TearDown,
    xpwm002Execute
...
// Xpwm test suits.
//
const tTestCase * const psPatternxpwm01[] =
{
    &sTestxpwm002Register,
    0
};