...
unsigned long ulWDT0ClkSource[] = {
0,SYSCTL_PERIPH_WDG_S_HCLK_2048, SYSCTL_PERIPH_WDG_S_INT10K};
...
SYSCTL_PERIPH_TMR0_S_EXT32K , SYSCTL_PERIPH_TMR0_S_HCLK, SYSCTL_PERIPH_TMR0_S_INT22M};


unsigned long ulTIMER1ClkSource[] = {SYSCTL_PERIPH_TMR1_S_EXT12M,
SYSCTL_PERIPH_TMR1_S_EXT32K , SYSCTL_PERIPH_TMR1_S_HCLK, SYSCTL_PERIPH_TMR1_S_INT22M};


unsigned long ulTIMER2ClkSource[] = {SYSCTL_PERIPH_TMR2_S_EXT12M,
SYSCTL_PERIPH_TMR2_S_EXT32K ,SYSCTL_PERIPH_TMR2_S_HCLK,  SYSCTL_PERIPH_TMR2_S_INT22M};


unsigned long ulTIMER3ClkSource[] = {SYSCTL_PERIPH_TMR3_S_EXT12M,
SYSCTL_PERIPH_TMR3_S_EXT32K , SYSCTL_PERIPH_TMR3_S_HCLK, SYSCTL_PERIPH_TMR3_S_INT22M};
...
static void xsysctl_SysCtlSysTickSourceSet_test(void)
{
    ...
    SysCtlSysTickSourceSet(ulSysTickClkSource[4]);
    ulTemp = xHWREG(SYSCLK_CLKSEL0);
...
static void xsysctl_SysCtlPeripheralClockSourceSet_test(void)
{
    ...
    SysCtlPeripheralClockSourceSet(ulTIMER0ClkSource[3]);
    ulTemp = xHWREG(SYSCLK_CLKSEL1);
    ...
    SysCtlPeripheralClockSourceSet(ulTIMER1ClkSource[3]);
    ulTemp = xHWREG(SYSCLK_CLKSEL1);
    ...
    SysCtlPeripheralClockSourceSet(ulTIMER2ClkSource[3]);
    ulTemp = xHWREG(SYSCLK_CLKSEL1);
    ...
    SysCtlPeripheralClockSourceSet(ulTIMER3ClkSource[3]);
    ulTemp = xHWREG(SYSCLK_CLKSEL1);
