...
unsigned long ulxWDT0ClkSource[] = {0,xSYSCTL_WDT0_HCLK_2048, xSYSCTL_WDT0_INTSL};
...
xSYSCTL_TIMER3_HCLK, xSYSCTL_TIMER3_INT};
...
static void xsysctl_xSysCtlPeripheralClockSourceSet_test(void)
{
    ...
    xSysCtlPeripheralClockSourceSet(ulxTIMER0ClkSource[3], 1);
    ulTemp = xHWREG(SYSCLK_CLKSEL1);
    ...
    xSysCtlPeripheralClockSourceSet(ulxTIMER1ClkSource[3], 1);
    ulTemp = xHWREG(SYSCLK_CLKSEL1);
    ...
    xSysCtlPeripheralClockSourceSet(ulxTIMER2ClkSource[3], 1);
    ulTemp = xHWREG(SYSCLK_CLKSEL1);
    ...
    xSysCtlPeripheralClockSourceSet(ulxTIMER3ClkSource[3], 1);
    ulTemp = xHWREG(SYSCLK_CLKSEL1);
