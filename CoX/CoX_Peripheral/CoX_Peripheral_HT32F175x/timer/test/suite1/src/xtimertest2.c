                                       ...
                                       void *pvMsgData)
{
	 ...
	 xHWREG(TIMER0_BASE + TIMER_ICTR) &= ~TIMER_DICTR_UEVIE;
     TestEmitToken('b');
     return 0;
}
                                       ...
                                       void *pvMsgData)
{
	 ...
	 xHWREG(TIMER1_BASE + TIMER_ICTR) &= ~TIMER_DICTR_UEVIE;
     TestEmitToken('b');
     return 0;
}
...
//
//*****************************************************************************
const char* xTimer002GetTest(void)
{
    static const char * const pcName = "xTimer [002]: xtimer counter interrupt test";
    return pcName;
}
