...
//! - \p Board: HT32F175x Development Board<br><br>
...
{
    static 	const char * const pcNane = "xcore, 001, xcore interrupt corresponding APIS test";
    return pcNane;
}
...
static void xcore001Execute(void)
{
	...
	//
    xIntPrioritySet(15, 2);
	ulTemp = xIntPriorityGet(15);
	...
	*/
    ...
    TestAssert(0 == ulTemp, "Int Disable Test fail");
 	...
 	xIntEnable(xINT_SPI0);
	xIntDisable(xINT_SPI0);
