...
{    
    ...
    //
    xGPIOPinIntEnable(xGPIO_PORTA_BASE, xGPIO_PIN_0, xGPIO_FALLING_EDGE);
    ...
    // Set GPIO pin interrupt callback.
    //
    xGPIOPinIntCallbackInit(xGPIO_PORTB_BASE, xGPIO_PIN_0, user_Callback1);
    
    //
    // Enable GPIO pin interrupt.
    //
    xGPIOPinIntEnable(xGPIO_PORTB_BASE, xGPIO_PIN_0, xGPIO_BOTH_EDGES);
    ...
    // Set PD.3 mode in.
    //  
    xGPIODirModeSet(xGPIO_PORTD_BASE, xGPIO_PIN_3, xGPIO_DIR_MODE_IN);
    
    //
    // Set GPIO pin interrupt callback.
    //
    xGPIOPinIntCallbackInit(xGPIO_PORTD_BASE, xGPIO_PIN_3, user_Callback3);
    
    //
    // Enable GPIO pin interrupt.
    //
    xGPIOPinIntEnable(xGPIO_PORTD_BASE, xGPIO_PIN_3, xGPIO_FALLING_EDGE);
    ...
    // Set GPIO pin interrupt callback.
    //
    xGPIOPinIntCallbackInit(xGPIO_PORTE_BASE, xGPIO_PIN_0, user_Callback4);
    
    //
    // Enable GPIO pin interrupt.
    //
    xGPIOPinIntEnable(xGPIO_PORTE_BASE, xGPIO_PIN_0, xGPIO_FALLING_EDGE);
