...
unsigned long ulxPWMAClkSource[] = {xSYSCTL_PWMA_MAIN, xSYSCTL_PWMA_HCLK,
                                                              xSYSCTL_PWMA_INT};

unsigned long ulxPWMBClkSource[] = {xSYSCTL_PWMB_MAIN, xSYSCTL_PWMB_HCLK, 
                                                             xSYSCTL_PWMB_INT};
...
unsigned long ulxUART1ClkSource[] = {xSYSCTL_UART1_MAIN, xSYSCTL_UART1_PLL,
                                                             xSYSCTL_UART1_INT};

unsigned long ulxTIMER0ClkSource[] = {xSYSCTL_TIMER0_MAIN,
xSYSCTL_TIMER0_HCLK, xSYSCTL_TIMER0_INT};


unsigned long ulxTIMER1ClkSource[] = {xSYSCTL_TIMER1_MAIN,
xSYSCTL_TIMER1_HCLK, xSYSCTL_TIMER1_INT};


unsigned long ulxTIMER2ClkSource[] = {xSYSCTL_TIMER2_MAIN,
xSYSCTL_TIMER2_HCLK, xSYSCTL_TIMER2_INT};


unsigned long ulxTIMER3ClkSource[] = {xSYSCTL_TIMER3_MAIN,xSYSCTL_TIMER3_HCLK, 
                                                            xSYSCTL_TIMER3_INT};

unsigned long ulxFRQDIVClkSource[] = {xSYSCTL_FRQDIV_MAIN, xSYSCTL_FRQDIV_HCLK, 
                                                           xSYSCTL_FRQDIV_INT};

unsigned long ulxADC0ClkSource[] = {xSYSCTL_ADC0_MAIN, xSYSCTL_ADC0_PLL, 
                                          xSYSCTL_ADC0_HCLK, xSYSCTL_ADC0_INT};
//*****************************************************************************
//
...
static void xsysctl_xSysCtlPeripheralClockSourceSet_test(void)
{
    ...
    xSysCtlPeripheralClockSourceSet(ulxPWMBClkSource[0], 1);
    ulTemp = xHWREG(SYSCLK_CLKSEL2);
    TestAssert((0 == (ulTemp & SYSCLK_CLKSEL2_PWM45_M)>>SYSCLK_CLKSEL2_PWM45_S),
                                                          "xsysctl API error!");
    for(i = 1; i < 3; i++)
    {
        xSysCtlPeripheralClockSourceSet(ulxPWMBClkSource[i], 1);
        ulTemp = xHWREG(SYSCLK_CLKSEL2);
    ...
    xSysCtlPeripheralClockSourceSet(ulxTIMER2ClkSource[0], 1);
    ulTemp = xHWREG(SYSCLK_CLKSEL1);
    TestAssert((0 == (ulTemp & SYSCLK_CLKSEL1_TMR2_M)>>SYSCLK_CLKSEL1_TMR2_S),
                                                          "xsysctl API error!");
    
    xSysCtlPeripheralClockSourceSet(ulxTIMER2ClkSource[1], 1);
    ulTemp = xHWREG(SYSCLK_CLKSEL1);
    TestAssert((2 == (ulTemp & SYSCLK_CLKSEL1_TMR2_M)>>SYSCLK_CLKSEL1_TMR2_S),
                                                          "xsysctl API error!");
    
    xSysCtlPeripheralClockSourceSet(ulxTIMER2ClkSource[2], 1);
    ulTemp = xHWREG(SYSCLK_CLKSEL1);
    TestAssert((7 == (ulTemp & SYSCLK_CLKSEL1_TMR2_M)>>SYSCLK_CLKSEL1_TMR2_S),
                                                          "xsysctl API error!");
    
    xSysCtlPeripheralClockSourceSet(ulxTIMER3ClkSource[0], 1);
    ulTemp = xHWREG(SYSCLK_CLKSEL1);
    TestAssert((0 == (ulTemp & SYSCLK_CLKSEL1_TMR3_M)>>SYSCLK_CLKSEL1_TMR3_S),
                                                          "xsysctl API error!");
    
    xSysCtlPeripheralClockSourceSet(ulxTIMER3ClkSource[1], 1);
    ulTemp = xHWREG(SYSCLK_CLKSEL1);
    TestAssert((2 == (ulTemp & SYSCLK_CLKSEL1_TMR3_M)>>SYSCLK_CLKSEL1_TMR3_S),
                                                          "xsysctl API error!");
    
    xSysCtlPeripheralClockSourceSet(ulxTIMER3ClkSource[2], 1);
    ulTemp = xHWREG(SYSCLK_CLKSEL1);
    ...
    for(j = 1; j <= 16; j++)
    {
        ...
        xSysCtlPeripheralClockSourceSet(ulxUART0ClkSource[2], j);
        ulTemp = xHWREG(SYSCLK_CLKSEL1);
