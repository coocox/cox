...
unsigned long ulBodVoltage[] = {SYSCTL_BOD_2_2, SYSCTL_BOD_2_7, SYSCTL_BOD_3_7,
                                                                SYSCTL_BOD_4_3};
...
//*****************************************************************************
//
//! \brief xsysctl 005 test of tempature sensor enable test .
//!
//! \return None.
//
//*****************************************************************************
static void xsysctl_SysCtlTempatureSensorEnable_test(void)
{
    ...
    TestAssert((GCR_TEMPCR_VTEMP_EN == (ulTemp & GCR_TEMPCR_VTEMP_EN)), "xsysctl API error!");
