...
set v_gen_root=%v_repo_root_self%\CoX\CoX_Peripheral\CoX_Peripheral_M051\all\project
...
echo gen coide project: CoX\CoX_Peripheral\CoX_Peripheral_M051\all\project
