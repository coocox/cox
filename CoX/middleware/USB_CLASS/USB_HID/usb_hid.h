...
/**
 * @file	: usb_hid.h
 * @brief	: USB HID (Human Interface Device) Definitions
 * @version	: 1.1
 * @date	: 11. Mar. 2011
 * @author	: CooCox
 ****************************************************************************/
 ...
 * HID Subclass Codes
************************************************************************************************************/
#define HID_SUBCLASS_NONE               0x00              /*!<  NO  HID  SUBCLASS                        */
...
************************************************************************************************************/
#define HID_HID_DESCRIPTOR_TYPE         0x21			/*!<  Hid Description                       	   */
#define HID_REPORT_DESCRIPTOR_TYPE      0x22            /*!<  Report Description                           */
#define HID_PHYSICAL_DESCRIPTOR_TYPE    0x23            /*!<  Physical Description                         */
...
typedef struct _HID_DESCRIPTOR {
  uint8_t  bLength;                                    /*!<  Length of Description                        */
  uint8_t  bDescriptorType;                            /*!<  Type of Description        HID = 21H         */
  uint16_t bcdHID;                                     /*!<  Version  of   HID                            */
  uint8_t  bCountryCode;                               /*!<  Country Code                                 */
  uint8_t  bNumDescriptors;                            /*!<  Number of support's other   Description      */
  /* Array of one or more descriptors */
  struct _HID_DESCRIPTOR_LIST {
    uint8_t  bDescriptorType;                          /*!<  Type of attached's   Description             */
    uint16_t wDescriptorLength;                        /*!<  Length of all of  Description                */
 ...
 * HID Request Codes
************************************************************************************************************/
#define HID_REQUEST_GET_REPORT          0x01            /*!<  Request of Get Report                        */
#define HID_REQUEST_GET_IDLE            0x02            /*!<  Request of Get Idle speed                    */
#define HID_REQUEST_GET_PROTOCOL        0x03            /*!<  Request of Get Hid Protocol                  */
#define HID_REQUEST_SET_REPORT          0x09            /*!<  Request of Set Report           		       */
#define HID_REQUEST_SET_IDLE            0x0A            /*!<  Request of Set Idle speed                    */
#define HID_REQUEST_SET_PROTOCOL        0x0B            /*!<  Request of Set Hid Protocol                  */


/********************************************************************************************************//**
 * HID Report Types
************************************************************************************************************/
#define HID_REPORT_INPUT                0x01            /*!<  Report of  Hid Input   		               */
#define HID_REPORT_OUTPUT               0x02			/*!<  Report of  Hid Output   		               */
#define HID_REPORT_FEATURE              0x03     		/*!<  Report of  Hid Feature   		               */
