...
//
//*****************************************************************************
static char* W25Xxx001GetTest(void)
{
...
//
//*****************************************************************************
static void W25Xxx001Setup(void)
{
...
//
//*****************************************************************************
static void W25Xxx001TearDown(void)
{   
...
//
//*****************************************************************************
static void W25XxxRWTest(void)
{
    W25XxxChipErase();
    W25XxxWrite(ucWriteData, 0, Length);
    xSysCtlDelay(500000);
    W25XxxDataRead(ucReadData, 0, Length);
    for(i = 0; i < Length; i++)
    {
...
//
//*****************************************************************************
static void W25XxxEraseChipTest(void)
{
    //
    // Erase all chip
    //
...
//
//*****************************************************************************
static void W25XxxReadIDTest(void)
{
    unsigned short usID;
    usID = W25XxxIDcodeGet();
...
//
//*****************************************************************************
static void W25Xxx001Execute(void)
{
    W25XxxReadIDTest();
    W25XxxRWTest();
    W25XxxEraseChipTest();
