...
set v_gen_root=%v_repo_root_self%\CoX\Driver\LCD_Character\SSD2119
set v_coide_empty_project=%v_repo_root_self%\CoX\resource\cox_coide_empty_project_lm3sxx
